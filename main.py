from utils import read_vid, save_vid, measure_distance, draw_player_stats, convert_pixel_distance_to_meters
import constants
import cv2
...
def main():
    ...
    player_mini_court_detections, ball_mini_court_detections = mini_court_obj.convert_bounding_boxes_to_mini_court_coordinates(player_detections, ball_detections, court_keypoints) 
    ...
    output_video_frames = mini_court_obj.draw_points_on_mini_court(output_video_frames, player_mini_court_detections)
    output_video_frames = mini_court_obj.draw_points_on_mini_court(output_video_frames, ball_mini_court_detections, color=(0, 255, 255))
